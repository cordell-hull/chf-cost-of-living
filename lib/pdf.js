...
export class PDFGenerator {
  ...
  async generate(report, onProgress = () => {}) {
    ...
    const sports = [
      ['Baseball', report.entertainment.baseball, report.entertainment.baseballNA],
      ['Football / Soccer', report.entertainment.football, report.entertainment.footballNA],
      ['Basketball', report.entertainment.basketball, report.entertainment.basketballNA],
      [report.entertainment.otherName || 'Other', report.entertainment.otherCost, report.entertainment.otherNA]
    ];
