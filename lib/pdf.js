...
export class PDFGenerator {
  ...
  async generate(report, onProgress = () => {}) {
    ...
    this.addSpace(15);
    this.drawWrappedText(
      'For further information, all costs associated with the J-1 visa are listed on the Cordell Hull Foundation website: www.cordell-hull.org/teacher-costs-associated-with-the-j-1-teacher-visa',
      this.margins.left + 5, this.contentWidth - 10,
