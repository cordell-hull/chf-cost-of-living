...
export class PDFGenerator {
  ...
  async generate(report, onProgress = () => {}) {
    ...
    if (insOffered && report.healthInsurance.monthlyCostToTeacher) {
    ...
    if (report.taxes.noStateTax) {
      this.drawCostRow('State income tax', 'N/A - No state income tax');
    ...
    const sports = [
      ['Broadway Show', report.entertainment.broadway, report.entertainment.broadwayNA],
      ['Professional Baseball', report.entertainment.baseball, report.entertainment.baseballNA],
      ['Professional Basketball', report.entertainment.basketball, report.entertainment.basketballNA],
      ['Professional Hockey', report.entertainment.hockey, report.entertainment.hockeyNA]
    ];

    for (const [name, cost, isNA] of sports) {
      if (isNA) {
        this.drawCostRow(name, 'N/A');
      } else if (cost) {
